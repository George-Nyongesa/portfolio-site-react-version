...
const PROJECTS = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1589254066213-a0c9dc853511?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
          ...
          {PROJECTS.map((p) => (
            <div key={p.title} className="card project-card">
              ...
              <div className="project-links">
                {/* Temporary placeholders that won’t break ESLint */}
                <a
                  href="/"
                  className="btn"
        ...
        <div className="project-grid" style={{ marginTop: 20 }}>
          ...
          <div className="card project-card">
            ...
            <div className="project-content">
              ...
              <p>
                A modern chat application with real-time messaging, file sharing
                and video calls. Built with Socket.io and WebRTC.
              </p>
              <div className="project-tech">
          ...
          <div className="card project-card">
            ...
            <div className="project-content">
              ...
              <p>
                A comprehensive analytics dashboard for portfolio tracking with
          ...
          <div className="card project-card">
            ...
            <div className="project-content">
              ...
              <p>
                A cross-platform fitness tracking app with workout plans,
                progress tracking, and social features for fitness enthusiasts.
              </p>
              <div className="project-tech">
